        ...
        <div class="top-inner clearfix">
            <div class="left-column pull-left">
                <ul class="info clearfix">
                    ...
                    <li><i class="far fa-phone"></i><a href="tel:+249-9-12233251">+249-9-12233251</a></li>
                </ul>
            </div>
            <div class="right-column pull-right">
                ...
                @auth
                <div class="sign-box">
                    <a href="{{ route('dashboard') }}"><i class="fas fa-tachometer"></i> Dashboard </a><span class="dashh"> | </span>
                </div>
...
<div class="main-box">
<div class="logo-box">
<figure class="logo"><a href="{{ url('/') }}"><img src="{{ '../../../frontend/assets/images/logo.png' }}" alt=""></a></figure>
</div>
